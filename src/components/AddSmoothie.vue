<template>
    <div class="div add-smoothie container">
        <h2 class="center-align  text">Add New Smoothie Recipie</h2>
      ...
      AddSmoothie(){
        ...
        addIng(){
            if(this.another){
                ...
                this.feedback = 'Please enter an ingredient to add it to the recipie'
            }
        },
        deleteIng(ing){
